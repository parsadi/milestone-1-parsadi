...
# DEPLOYMENT PROCESS
The next thing is deployment, i deploy this website using Vercel. Here are the step:

1. Make sure you signing in on Vercel first, and choose your gitHub repository that you intend to deploy (import it)
![deploy 1](./readme.assets/Screenshot%20(37).png)

2.Name your project as you wish. In this case i named it as my repository name
![deploy 2](./readme.assets/Screenshot%20(38).png)

3.Wait for a moment, then your website has benn deployed. Congratulations.
![deploy 3](./readme.assets/Screenshot%20(39).png)

4.Now you can accsess your website online.
![deploy 4](./readme.assets/Screenshot%20(40).png)

website address : 
https://vercel.com/parsadis-projects/milestone-1-parsadi/CxPxDDCHEwQ84hiJ8umj9LiV8z93